...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3055217782ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=chat62&table=chat_content_in_group">`chat62`.`chat_content_in_group`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=chat62&table=chatcontent">`chat62`.`chatcontent`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=chat62&table=user">`chat62`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=chat62&table=groupchat">`chat62`.`groupchat`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=it_media_social&table=tuvan">`it_media_social`.`tuvan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=it_media_social&table=menu_parent">`it_media_social`.`menu_parent`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=it_media_social&table=menu_child">`it_media_social`.`menu_child`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=it_media_social&table=notification">`it_media_social`.`notification`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=it_media_social&table=bill">`it_media_social`.`bill`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=it_media_social&table=login_pw">`it_media_social`.`login_pw`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="3c3b37315759695c2e5b5f282c315a5c">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="it_media_social" targettable="login_pw">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `login_pw`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="it_media_social" targettable="menu_child">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `menu_child`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="it_media_social" targettable="notification">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `notification`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="it_media_social" targettable="bill">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `menu_child`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="it_media_social" targettable="menu_parent">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `menu_parent`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="it_media_social" targettable="menu_child">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `menu_parent`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="it_media_social" targettable="tuvan">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tuvan`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="chat62" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `chat62`.`user` ( `username` VARCHAR(255) NOT NULL ,  `name` VARCHAR(200) NOT NULL ,  `password` VARCHAR(255) NOT NULL ,    PRIMARY KEY  (`username`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="chat62" targettable="groupchat">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `chat62`.`groupchat` ( `name_group` VARCHAR(255) NOT NULL ,  `user_join` VARCHAR(255) NOT NULL ,  `id` INT NOT NULL AUTO_INCREMENT ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="chat62" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="chat62" targettable="chatcontent">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `chat62`.`chatcontent` ( `id` INT NOT NULL AUTO_INCREMENT ,  `userSend` VARCHAR(255) NOT NULL ,  `content` TEXT NOT NULL ,  `receiver` VARCHAR(255) NOT NULL ,  `type` VARCHAR(50) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="chat62" targettable="chat_content_in_group">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `chat62`.`chat_content_in_group` ( `id` INT NOT NULL AUTO_INCREMENT ,  `name_group` VARCHAR(255) NOT NULL ,  `user_send` VARCHAR(255) NOT NULL ,  `content` TEXT NOT NULL ,  `type` VARCHAR(50) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="chat62" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `chatcontent`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="chat62" targettable="chatcontent">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `chat_content_in_group`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="chat62" targettable="chat_content_in_group">
                            <div class="action_content">
